...
#define CONSOLE_NAME        LR"(ConDrv)"
#define CONSOLE_DRIVER_NAME LR"(\Driver\condrv)"
#define CONSOLE_DEVICE_NAME LR"(\Device\)"      CONSOLE_NAME
#define CONSOLE_DOS_NAME    LR"(\DosDevices\)"  CONSOLE_NAME
